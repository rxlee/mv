<?php
/*
	[seacms1.0] (C)2011-2012 ysyz.xyz
*/
if(!defined('sea_INC'))
{
	exit("Request Error!");
...
{
	return "<p>Powered by <strong><a href=\"http://ysyz.xyz\" title=\"".$GLOBALS['cfg_softname']."\" target=\"_blank\">".$GLOBALS['cfg_soft_enname']."</a></strong> <em>".$GLOBALS['cfg_version']."</em></p>";
}
